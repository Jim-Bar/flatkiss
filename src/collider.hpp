...
class Collider {
 public:
   ...
   *
   * @param CollisionsPerTileIndex Map of tile indices to their respective
   * collisions.
   */
  Collider(
   ...
   */
  bool collide(PositionedRectangle const& PositionedRect, uint16_t TileIndex,
               Position const& TilePosition) const;
