#ifndef SPRITE_INDICES_HPP_INCLUDED
#define SPRITE_INDICES_HPP_INCLUDED
...
class SpriteIndices {
 public:
  /**
   * @brief Construct a SpriteIndices from a map of actions to matching sprite
   * indices.
   *
   ...
   */
  SpriteIndices(std::unordered_map<Action, uint16_t>&& action_to_indices);
...
class SpriteIndicesLoader {
 public:
  static std::unordered_map<int64_t, SpriteIndices const> load(
